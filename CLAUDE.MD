...
python3 -m photojobs teams --csv "MyJob2025 DATA-PNG.csv" --root ./images_folder
```

## Known Issues & TODOs

1. **Stub implementations**: verify and rename commands need full implementation
...
- Production-ready commands: `keywords`, `csvgen`, `teams`
